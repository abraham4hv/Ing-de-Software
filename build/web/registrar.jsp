<%-- 
    Document   : registrar
    Created on : Nov 2, 2017, 7:23:30 PM
    Author     : sotg10
--%>
                ...
                <div class="head">
                    <div class="head-nav-grids">
                        <div class="navbar-top">
                            ...
                            <div class="navbar-header">
                                ...
                                <div class="navbar-brand logo ">
                                    <img src="images/Logo/White/PNG/name_1.png" alt="">
                                </div>
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav link-effect-4">
                                    ...
                                    <li class="active"><a href="login.jsp" data-hover="Login">Iniciar Sesion</a></li>
                                </ul>
                            </div><!-- /.navbar-collapse -->
                        </div>
                        ...
                        <div class="header-left">
                            <ul>
                                <li><i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:info@example.com">kitchen@example.com</a></li>
            ...
            <div class="container">	
                <div class="contact-form">
                    ...
                    <form action="registrar" method="post">
                        ...
                        <input type="date" name="cumple" placeholder="Fecha de Nacimiento: DD/MM/YYYY" required="">
        ...
        <div class="w3-agile-footer">
            <div class="container">
                ...
                <div class="agileits-w3layouts-copyright">
                    <p>© 2017 Kitchen. All Rights Reserved</p>
                </div>
            </div>
        </div>
        <!-- //footer -->
