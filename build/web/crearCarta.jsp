<%-- 
    Document   : crearCarta
    Created on : Nov 17, 2017, 3:44:31 PM
    Author     : sotg10
--%>
                            ...
                            <div class="navbar-top">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav link-effect-4">
                                        ...
                                        <li class="dropdown">
                                            <a href="codes.html" class="dropdown-toggle" data-hover="Mantenimientos" data-toggle="dropdown">Mantenimientos<b class="caret"></b></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="crearCarta.jsp">Agregar Platillos</a></li>
                                            </ul>
                                        </li>
            ...
            <div class="typography">
                <div class="container">
                    <div class="contact-form">
                        <h3>Crear Platillos</h3>
                        <form action="ingresarPlatillo" method="post">
                            <input type="text" name="nombre" placeholder="Nombre de platillo" required="">
                            <input type="text" name="categoria" placeholder="Categoria" required="">
                            <input type="text" name="subcategoria" placeholder="Sub Categoria" required="">
                        ...
                        <div class="bs-docs-example wow fadeInUp animated" data-wow-delay=".5s">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><%=casa.getString("nombre")%></td>
                                        <td><%=casa.getString("categoria")%></td>
                                        <td><%=casa.getString("subCategoria")%></td>
                                        <td><%=casa.getString("descripcion")%></td>
                                        <td><%=casa.getString("precio")%></td>
                                    </tr>
                                    <% }%>
                                </tbody>
                            </table>
